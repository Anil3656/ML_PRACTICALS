...
dataset = pd.read_csv(r"D:\Data Science Daily Updates\Senapthi_calss_Notes\MACHINE LEARNING CLASS\4.Clustering Algorithms\2.K-Mean Clustering\Practicals\Mall_Customers.csv")
